...
/* I want to reverse the button so when you are on light mode, the button says light mode and when you are on dark mode, the button states you are in dark mode so it is less confusing.i also realised that this said isDark= true in this statement so I have to change this into darkmode.*/
